...
@section('scripts')
    ...
    <script>
        new_message_url = '{{route('parent.booking-chat', $booking->id)}}';
    </script>
@endsection
        ...
        <div class="container">
            ...
            <div class="columns">
                ...
                <div class="column is-8">
                    <h2 class="title is-4 has-text-primary">Chat with babysitter</h2>
                    <p class="subtitle">Booking ID {{$booking->idPadded}}</p>
